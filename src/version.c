...
char *generation = "126";
char *creation = "Fri Aug 21 2015 at 09:51:45 BST";
char version[128];
...
char *infotext[] =
    {
	 ...
	 "",
	 "You are currently using a modified version of bahamut called ircd-rainbow-trout.",
	 "Features in this IRCd may not reflect those in bahamut.",
	 "",
	 0,
};
